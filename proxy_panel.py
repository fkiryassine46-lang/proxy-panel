...
# ---- LAYOUT : nouveau thème teal/vert ----
LAYOUT_TEMPLATE = """
...
<head>
  ...
  <style>
    :root {
      ...
      --accent-bad: #f97316; /* orange pour erreurs */
      --accent-ok: #22c55e;
      --accent-warn: #eab308;
    }
    * { box-sizing:border-box; }
    body {
      ...
      background:
        ...
        radial-gradient(circle at 100% 0%, rgba(34,197,94,0.08), transparent 55%),
    ...
    .card {
      background:
        ...
        radial-gradient(circle at 100% 0%, rgba(34,197,94,0.18), transparent 45%),
